...
5. Expand the list of values under **Availability Zones** and select the first two zones:

   - us-east-1a
   - us-east-1b

6. Expand the list of values under **Subnets** and select the subnets associated with the CIDR ranges:
...
17. Paste the Endpoint value into a text editor.
...
6. Test the web application by adding, editing and removing contacts.
